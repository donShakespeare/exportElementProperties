<?php
$packageNameLower = 'exportelementproperties'; /* No spaces, no dashes */

$components = array(
    /* These are used to define the package and set values for placeholders */
    'packageName' => 'exportElementProperties',  /* No spaces, no dashes */
    'packageNameLower' => $packageNameLower,
    'packageDescription' => 'exportElementProperties project for MyComponent extra',
    'version' => '1.0.0',
    'release' => 'beta1',
    'author' => 'donShakespeare',
    'email' => '',
    'authorUrl' => 'https://github.com/donShakespeare/exportElementProperties',
    'authorSiteName' => "exportElementProperties",
    'packageDocumentationUrl' => 'https://github.com/donShakespeare/exportElementProperties',
    'copyright' => '2016',
    ...
    */
    ...
    'exportelementproperties' => array(
        'exportelementproperties' => array(
            'name' => 'exportelementproperties',
            'path' => '{core_path}components/exportelementproperties/',
            'assets_path' => '{assets_path}components/exportelementproperties/',
        ),
    ...
    */
    ...
    'cmpJsFiles' => array(
        ':exportelementproperties.class.js',
        'sections:home.js',
